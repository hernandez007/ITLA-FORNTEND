const name = document.querySelector('#name'),
    ...
    nameStudent = document.querySelector('#nameStudent'),
    ...
    nameStudentError = document.querySelector('#nameStudentError'),
...
btnSend.addEventListener('click',async (e)=>{
    ...
    await validationForm(nameStudent,90,nameStudentError,messageValidateFieldBlank,messageValidateLimet,messageValidateFormat,nameRegex);
    ...
    if (isValid) {
        const objInfoForm = {
            ...
            nombre_estudiante:nameStudent.value
        }
